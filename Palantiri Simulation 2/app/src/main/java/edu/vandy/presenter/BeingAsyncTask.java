...
public class BeingAsyncTask
    ...
    public Void doInBackground(PalantiriPresenter... presenters) {
        ...
        for (;
            ...
            try {
                ...
                /*
                 * Call MARK methods that return a runnable and pass to the a
                 * appropriate method in AsyncTask, to communicate that runnable to UI thread
                 * Activity Layer
                 */
                ...
                publishProgress(presenter.mView.get().markGazing(palantir.getId()));
     ...
     */
    @Override
    public void onProgressUpdate(final Runnable ...runnableCommands) {
