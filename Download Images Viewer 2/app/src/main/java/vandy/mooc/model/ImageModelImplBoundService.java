...
public class ImageModelImplBoundService 
    ...
    protected void bindService() {
        ...
        if (mRequestMessengerRef == null) {
            ...
            //factory method inside of DownloadImagesBoundService
            //Model layer context needs to be referenced

            final Intent intent = DownloadImagesBoundService.makeIntent
                    (mImagePresenter.get().getActivityContext());

            Log.d(TAG,
                  "calling bindService() is NULL");

            // Bind to the Service associated with the Intent.
            // TODO -- you fill in here.
            //bindService() uses the activity context not the service context
    ...
    protected void unbindService() {
        ...
        if (mRequestMessengerRef != null) {
            ...
            // TODO -- you fill in here.
            mImagePresenter.get().getApplicationContext()
        ...
        if (mRequestMessengerRef == null) 
            ...
            try {
                ...
                if(requestMessage.getMessage() == null)
                    Log.e(TAG, "your requestMessage is NULL");
