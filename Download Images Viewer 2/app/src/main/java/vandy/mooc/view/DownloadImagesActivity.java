...
public class DownloadImagesActivity 
     ...
     * @return true
     */
    public boolean chooseService(MenuItem item) {
        switch (item.getItemId()) {
        case R.id.bound:
            getPresenter().getModel()
                          .setServiceType
                              (ImageModel.ServiceType.BOUND_SERVICE);
            Utils.showToast(this,
                            "Bound Service selected");
            break;

        case R.id.started:
            getPresenter().getModel()
                          .setServiceType
                              (ImageModel.ServiceType.STARTED_SERVICE);                
            Utils.showToast(this,
                            "Started Service selected");
            break;
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.service_menu,
                         menu);
        return true;
    }
}
