...
//	static private final String STRING_EXTRA = "stringExtra";
	...
	private void startImplicitActivation() {
		...
		Intent chooserIntent = Intent.createChooser(baseIntent, TITLE_TEXT);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(requestCode == GET_TEXT_REQUEST_CODE) {
			if(resultCode == RESULT_OK) {
				...
				mUserTextView.setText(data.getExtras().getString(ExplicitlyLoadedActivity.STRING_EXTRA));
				Log.e(TAG, data.getExtras().getString(ExplicitlyLoadedActivity.STRING_EXTRA));
			}
		}
